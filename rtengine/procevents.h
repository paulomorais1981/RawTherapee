...
//  EvFixedch=235,   -- can be reused --
    ...
    EvLocrgbenaexpose = 544,
    EvlocalrgbEnabled = 545,
    EvlocalrgblocY = 546,
    EvlocalrgblocX = 547,
    EvlocalrgbCenter = 548,
    EvlocalrgbDegree = 549,
    Evlocalrgblightness = 550,
    Evlocalrgbcontrast = 551,
    Evlocalrgbchroma = 552,
    Evlocalrgbtransit = 553,
    EvlocalrgblocYT = 554,
    EvlocalrgblocXL = 555,
    EvlocalrgbSmet = 556,
    Evlocalrgbsensi = 557,
    Evlocalrgbnbspot = 558,
    Evlocalrgbanbspot = 559,
    Evlocalrgbhueref = 560,
    Evlocalrgbchromaref = 561,
    Evlocalrgblumaref = 562,
    Evlocalrgbthres = 563,
    Evlocalrgbproxi = 564,
    Evlocalrgbcircrad = 565,
    EvlocalrgbqualityMethod = 566,
    Evlocalrgbretrab = 567,
    Evlocalrgbexpcomp = 568,
    Evlocalrgbhlcompr = 569,
    Evlocalrgbhlcomprthresh = 570,
    Evlocalrgbblack = 571,
    Evlocalrgbshcompr = 572,
    EvlocalrgbCurve1 = 573,
    EvlocalrgbCurve2 = 574,
    EvlocalrgbCurveMode1 = 575,
    EvlocalrgbCurveMode2 = 576,
    EvLocrgbenawb = 577,
    Evlocalrgbtemp = 578,
    Evlocalrgbgreen = 579,
    Evlocalrgbequal = 580,
