...
//  EvFixedch=235,   -- can be reused --
    ...
    EvLocrgbenaexpose = 545,
    EvlocalrgbEnabled = 546,
    EvlocalrgblocY = 547,
    EvlocalrgblocX = 548,
    EvlocalrgbCenter = 549,
    EvlocalrgbDegree = 550,
    Evlocalrgblightness = 551,
    Evlocalrgbcontrast = 552,
    Evlocalrgbchroma = 553,
    Evlocalrgbtransit = 554,
    EvlocalrgblocYT = 555,
    EvlocalrgblocXL = 556,
    EvlocalrgbSmet = 557,
    Evlocalrgbsensi = 558,
    Evlocalrgbnbspot = 559,
    Evlocalrgbanbspot = 560,
    Evlocalrgbhueref = 561,
    Evlocalrgbchromaref = 562,
    Evlocalrgblumaref = 563,
    Evlocalrgbthres = 564,
    Evlocalrgbproxi = 565,
    Evlocalrgbcircrad = 566,
    EvlocalrgbqualityMethod = 567,
    Evlocalrgbretrab = 568,
    Evlocalrgbexpcomp = 569,
    Evlocalrgbhlcompr = 570,
    Evlocalrgbhlcomprthresh = 571,
    Evlocalrgbblack = 572,
    Evlocalrgbshcompr = 573,
    EvlocalrgbCurve1 = 574,
    EvlocalrgbCurve2 = 575,
    EvlocalrgbCurveMode1 = 576,
    EvlocalrgbCurveMode2 = 577,
    EvLocrgbenawb = 578,
    Evlocalrgbtemp = 579,
    Evlocalrgbgreen = 580,
    Evlocalrgbequal = 581,
